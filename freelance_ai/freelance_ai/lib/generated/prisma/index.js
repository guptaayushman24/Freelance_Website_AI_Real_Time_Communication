...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Freelance_Project\\freelance_ai\\freelance_ai\\lib\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../freelance_ai/lib/generated/prisma",
    "freelance_ai/lib/generated/prisma",
  ]
...
path.join(process.cwd(), "../freelance_ai/lib/generated/prisma/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "../freelance_ai/lib/generated/prisma/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../freelance_ai/lib/generated/prisma/schema.prisma")
