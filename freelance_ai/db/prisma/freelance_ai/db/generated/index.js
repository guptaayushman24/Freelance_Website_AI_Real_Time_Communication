...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\Freelance_Project\\freelance_ai\\db\\prisma\\freelance_ai\\db\\generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/freelance_ai/db/generated",
    "freelance_ai/db/generated",
  ]
...
path.join(process.cwd(), "prisma/freelance_ai/db/generated/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "prisma/freelance_ai/db/generated/libquery_engine-rhel-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "prisma/freelance_ai/db/generated/libquery_engine-debian-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-linux-musl.so.node");
path.join(process.cwd(), "prisma/freelance_ai/db/generated/libquery_engine-linux-musl.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/freelance_ai/db/generated/schema.prisma")
