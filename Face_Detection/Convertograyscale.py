...
# folder_path_captured_image = os.path.join('Face_Detection', 'image')
folder_path_gray_image = 'Face_Detection/Gray_Image/Readme.md'
folder_path_gray_image = os.path.join('Face_Detection', 'Gray_Image')
