...
app.get('/findthesizeofdb', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, client.faceAuthentication.count()];
            case 1:
                data = _a.sent();
                return [2 /*return*/, res.status(200).json({ data: data })];
            case 2:
                err_2 = _a.sent();
                return [2 /*return*/, res.json({ 'msg': err_2 })];
            case 3: return [2 /*return*/];
        }
    });
}); });
app.get('/getallimagestring', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, client.faceAuthentication.findMany({})];
            case 1:
                data = _a.sent();
                return [2 /*return*/, res.status(200).json(data)];
            case 2:
                err_3 = _a.sent();
                return [2 /*return*/, res.json({ 'message': "Something wrong ".concat(err_3), 'status': 500 })];
            case 3: return [2 /*return*/];
        }
    });
}); });
